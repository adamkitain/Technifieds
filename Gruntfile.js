...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        copy:{
            ...
            prep:{
                files:[
                    {expand:true, cwd:'./app/', src:['img/**', 'styles/**', 'scripts/**', 'views/**/*.html', '*.html', 'template/**'], dest:'./tmp/'}
                ]
            },
            /*
            ...
            buildProdDev: {
                files:[
                    {expand:true, cwd:'./tmp/', src:['**'], dest:'./build/prod/'}
                ]
            },
            buildDev: {
                files:[
    ...
    grunt.registerTask('buildDev', [
        ...
        'copy:prep', // Copy img + lib + html: app/img/* + app -> tmp
        'template:dev', // Apply html templates: app -> tmp
        'copy:buildDev', // Copy: tmp -> dist
        'clean:temp' // Delete tmp
    ]);
